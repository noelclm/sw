            ...
            <div id="carcase" class="grow2">
                ...
                <article class="column">
                    ...
                    <form method="post" action="index.php">
                        ...
                        <p class="center"><input name="login" value="" placeholder="Usuario" type="text"></p>
                        <p class="center"><input name="password" value="" placeholder="Contraseña" type="password"></p>
                        <p class="center">
                          <label>
                            <input name="remember" id="remember" type="checkbox">
                            Recordar en este ordenador
                          </label>
                        </p>
                        <p class="center"><input name="commit" value="Iniciar Sesion" type="submit"></p>
